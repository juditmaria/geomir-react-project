  ...
  return (
    <div>
      <div className='position-absolute top-50 start-50 translate-middle d-grid gap-2 col-6 mx-auto'>
        ...
        <input type="text" class="form-control" placeholder="Email or username" aria-label="Email or username" aria-describedby="Put your email or username" required/>
        <div className="input-group mb-3">
          <input type="text" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="Put your password" required/>
